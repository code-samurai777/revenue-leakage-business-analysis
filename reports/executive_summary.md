...
2.2 High First-Order Churn

A significant proportion of customers place only one order. Cohort analysis shows sharp drop-offs after the first purchase, with weak long-term retention across cohorts.

2.3 Operational Delays Are Linked to Lower Repeat Behavior

Customers experiencing delivery delays tend to place fewer subsequent orders. While this analysis is correlational, it suggests that logistics performance is a key driver of customer retention and lifetime value.

2.4 Revenue Is Concentrated Among a Small Seller Group
...
Shift focus from low-value acquisition toward retention and repeat purchase incentives.
...
This analysis is based on historical transactional data and demonstrates correlations rather than causal relationships. Further experimentation (e.g., A/B testing delivery improvements) is required to confirm impact.
